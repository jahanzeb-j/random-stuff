...
class TestHTTPHandle(http.server.BaseHTTPRequestHandler):  
	...
	def do_POST(self):  
		...
		#fileName = 'D:\\audio\\output.wav' #for windows
		fileName = '/appl/freeware/tomcat/webapps/benz/document/wav/output.wav' #for Linux
		wavsignal,fs=read_wav_data(fileName)
		#datas= {'token':'qwertasd', 'fs':fs, 'wavs':wavsignal}
		#print(datas)
